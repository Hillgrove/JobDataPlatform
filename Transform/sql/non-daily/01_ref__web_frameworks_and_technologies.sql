...
SELECT * FROM UNNEST([
  ...
  STRUCT('angular'       AS framework_name, r'(?i)\bangular\b'                          AS pattern),
  ...
  STRUCT('spring'        AS framework_name, r'(?i)\bspring(\sboot|\sframework)?\b'      AS pattern),
  STRUCT('.net'          AS framework_name, r'(?i)\b\.net\b'                            AS pattern),
